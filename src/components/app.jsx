...
function App() {
    ...
    function handleExample() {
        ...
        setDegrees([{id: crypto.randomUUID(), degree: "Sociology", school: "University of Sociology", startDate: "02/2010", endDate: "03/2013", location: "Lisbon"} ,
            {id: crypto.randomUUID(), degree: "Political Science", school: "University of Porto", startDate: "09/2015", endDate: "10/2017", location: "Porto"}]);
        setExperiences([{id: crypto.randomUUID(), name: "Wood Company", title: "Carpenter", startDate: "05/2018", endDate: "present", location: "Aveiro", description: "Working making furniture out of wood"}]);
    }
